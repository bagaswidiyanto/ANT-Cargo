                    ...
                    <div class="heading">
                             ...
                             <form action="" method="post"><br>
                                ...
                                <p class="min40"><h4>Masukan lokasi asal dan tujuan serta berat untuk mengetahui tarif pengiriman kami</h4></p><br>
                                	<div class="row">
                                        <div class="inputform">
                                            <input type="text" id="hint" name="asal" class="form-control round dropdown-header" required="required"/>
					    <input type="hidden" id="asal" name="dari" class="dropdown-header" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="inputform">
                                            <input type="text" id="hint2" name="ke" class="form-control round dropdown-header" required="required"/>
					    <input type="hidden" id="tujuan" name="tujuan" class="dropdown-header" />
                                        </div>
                                    </div>
                                     <div class="row weight">
                                        <div class="inputform">
                                            <input type="text" class="form-control round weight" value="1" name ="berat" id="" placeholder="BERAT" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 text-center">
                                        <button type="submit" class="btn btn-lg btn-primary round">CEK TARIF</button>
                                </div>
                                <!-- /.row -->
                            </form>
                            </center>
